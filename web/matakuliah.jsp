<%-- 
    Document   : matakuliah
    Created on : Nov 28, 2013, 5:58:27 AM
    Author     : wx-eth0
--%>
...
<%@ taglib uri="http://struts.apache.org/tags-logic" prefix="tile" %>
                ...
                <div class="row-fluid">
                    <html:form method="post" action="/mhs.do">
                        <div class="span5">
                            ...
                            <input name="idmatkul" type="text" class="input-block-level" placeholder="Id Matakuliah">
                            <input name="matkul" type="text" class="input-block-level" placeholder="Matakuliah">
                            <input name="sks" type="text" class="input-block-level" placeholder="SKS">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <logic:notEmpty name="list1">
                                    <logic:iterate id="element" name="list1">
                                        ...
                                        <td> <bean:write name="element" property="idmatkul"/> </td>
                                        <td> <bean:write name="element" property="matkul"/> </td>
                                        <td> <bean:write name="element" property="sks"/> </td>
                                        <td> 
